...
@gaganrobot.on_cmd("sudo", about={'header': "enable / disable sudo access"}, allow_channels=False)
...
@gaganrobot.on_cmd("addsudo", about={
...
@gaganrobot.on_cmd("delsudo", about={
...
@gaganrobot.on_cmd("vsudo", about={'header': "view sudo users"}, allow_channels=False)
...
@gaganrobot.on_cmd("addscmd", about={
...
async def add_sudo_cmd(message: Message):
    ...
    if '-all' in message.flags:
        ...
        tmp_ = []
        for c_d in list(gaganrobot.manager.enabled_commands):
...
@gaganrobot.on_cmd("delscmd", about={
...
@gaganrobot.on_cmd("vscmd", about={'header': "view sudo cmds"}, allow_channels=False)
