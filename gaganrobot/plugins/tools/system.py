...
from gaganrobot.utils import terminate
...
async def restart_(message: Message):
    ...
    if 'h' in message.flags:
        if Config.HEROKU_APP:
            ...
            asyncio.get_event_loop().create_task(gaganrobot.restart(hard=True))
    else:
...
@gaganrobot.on_cmd("enhere", about={
...
@gaganrobot.on_cmd("dishere", about={
...
@gaganrobot.on_cmd("listdisabled", about={'header': "List all disabled chats."})
