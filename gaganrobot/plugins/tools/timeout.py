...
@gaganrobot.on_cmd("sdelto (\\d+)", about={
...
@gaganrobot.on_cmd("vdelto", about={'header': "View auto message delete timeout"})
...
@gaganrobot.on_cmd("swelto (\\d+)", about={
...
@gaganrobot.on_cmd("vwelto", about={'header': "View auto welcome/left message delete timeout"})
...
@gaganrobot.on_cmd("sapicto (\\d+)", about={
...
@gaganrobot.on_cmd("vapicto", about={'header': "View auto profile picture timeout"})
...
@gaganrobot.on_cmd("sesto (\\d+)", about={
...
@gaganrobot.on_cmd("vesto", about={'header': "View edit sleep timeout"})
