...
from gaganrobot import gaganrobot, Message, Config, get_collection, pool
from gaganrobot.utils import progress, humanbytes, time_formatter
...
class _GDrive:
    ...
    def _set_permission(self, file_id: str) -> None:
        ...
        _LOG.info("Set Permission : %s for Google-Drive File : %s",
                  permissions, file_id)
    ...
    def _upload_file(self, file_path: str, parent_id: str) -> str:
        ...
        body = {"name": file_name, "mimeType": mime_type,
                "description": "Uploaded using GaganRobot"}
        if parent_id:
    ...
    def _create_drive_dir(self, dir_name: str, parent_id: str) -> str:
        ...
        if not Config.G_DRIVE_IS_TD:
            self._set_permission(file_id)
        self._completed += 1
        _LOG.info("Created Google-Drive Folder => Name: %s ID: %s ",
                  file_name, file_id)
        return file_id
    ...
    def _get_perms(self, file_id: str) -> str:
        ...
        _LOG.info("All Permissions: %s for Google-Drive File : %s",
                  all_perms, file_id)
        return all_perms
...
@gaganrobot.on_cmd("gsetup", about={
...
@gaganrobot.on_cmd("gclear", about={
...
@gaganrobot.on_cmd("greset", about={
...
@gaganrobot.on_cmd("gshare", about={
...
@gaganrobot.on_cmd("gempty", about={
...
@gaganrobot.on_cmd("ggetperm", about={
...
@gaganrobot.on_cmd("gsetperm", about={
...
@gaganrobot.on_cmd("gdelperm", about={
