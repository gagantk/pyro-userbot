...
from gaganrobot.utils import sort_file_name_key, progress, take_screen_shot, humanbytes
from gaganrobot.utils.exceptions import ProcessCanceled
from gaganrobot.plugins.misc.download import tg_download, url_download
...
@gaganrobot.on_cmd("rename", about={
...
@gaganrobot.on_cmd("convert", about={
...
@gaganrobot.on_cmd("upload", about={
