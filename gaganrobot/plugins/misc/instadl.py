...
from gaganrobot import gaganrobot, pool, Message, Config
from gaganrobot.plugins.misc.upload import get_thumb, remove_thumb
            ...
            if str(path).endswith(pto):
                if captioned:
                    ...
                    media.append(InputMediaPhoto(
                        media=ab_path, caption=get_caption(post)[:1023]))
                    captioned = True
...
@gaganrobot.on_cmd("postdl", about={
        ...
        try:
            ...
            # This is a nightmare.
                ...
                for _ in range(4):
                    ...
                    async with gaganrobot.conversation(message.from_user.id) as asker:
