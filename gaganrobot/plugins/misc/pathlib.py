...
@gaganrobot.on_cmd("dclear", about={
...
@gaganrobot.on_cmd('dremove', about={
...
@gaganrobot.on_cmd('drename ([^|]+)\|([^|]+)', about={  # noqa
...
@gaganrobot.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
...
@gaganrobot.on_cmd('combine', about={
...
@gaganrobot.on_cmd('unpack', about={
...
@gaganrobot.on_cmd('packinfo', about={
