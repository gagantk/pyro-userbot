...
from gaganrobot import gaganrobot, Message, get_collection
...
@gaganrobot.on_cmd("setflood", about={
...
@gaganrobot.on_cmd("setmode", about={
...
@gaganrobot.on_cmd("vflood", about={
