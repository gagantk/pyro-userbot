...
from gaganrobot import gaganrobot, Message, filters, Config, get_collection
...
@gaganrobot.on_filters(IS_AFK_FILTER & ~filters.me & ~filters.bot & ~filters.edited & (
...
@gaganrobot.on_filters(IS_AFK_FILTER & filters.outgoing, group=-1, allow_via_bot=False)
