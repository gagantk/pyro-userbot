...
from gaganrobot.utils import post_to_telegraph, progress

_T_LIMIT = 5242880


@gaganrobot.on_cmd("telegraph", about={
...
async def telegraph_(message: Message):
    ...
    if replied.sticker:
        ...
        img.save(f'{Config.DOWN_PATH}/gaganrobot.png', 'png')
        os.remove(dl_loc)
        dl_loc = f'{Config.DOWN_PATH}/gaganrobot.png'
