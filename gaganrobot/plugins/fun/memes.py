...
@gaganrobot.on_cmd("Oof$", about={'header': "Ooooof"},
                   trigger='', allow_via_bot=False)
...
@gaganrobot.on_cmd("Hmm$", about={'header': "Hmmmmm"},
                   trigger='', allow_via_bot=False)
...
@gaganrobot.on_cmd("clock$", about={'header': "kensar clock animation"})
...
@gaganrobot.on_cmd("coinflip", about={
    'header': "Flip a coin !!",
...
@gaganrobot.on_cmd("(yes|no|maybe|decide)$", about={
...
WTF = ("༎ຶ‿༎ຶ", "(‿ˠ‿)", "╰U╯☜(◉ɷ◉ )", "(;´༎ຶ益༎ຶ`)♡",
       "╭∩╮(︶ε︶*)chu", "( ＾◡＾)っ (‿|‿)")

LOVE = ("乂❤‿❤乂", "(｡♥‿♥｡)", "( ͡~ ͜ʖ ͡°)", "໒( ♥ ◡ ♥ )७", "༼♥ل͜♥༽")

CONFUSED = ("(・_・ヾ", "｢(ﾟﾍﾟ)", "﴾͡๏̯͡๏﴿", "(￣■￣;)!?",
            "▐ ˵ ͠° (oo) °͠ ˵ ▐", "(-_-)ゞ゛")
