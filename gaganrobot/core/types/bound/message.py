...
from gaganrobot.utils import is_command
...
class Message(RawMessage):
    """ Modded Message Class For GaganRobot """
    def __init__(self,
    ...
    @classmethod
    def parse(cls, client: Union['_client.GaganRobot', '_client.GaganRobotBot'],
    ...
    @property
    def client(self) -> Union['_client.GaganRobot', '_client.GaganRobotBot']:
        """ returns client """
        return self._client
    ...
    async def err(self,
        ...
        Returns:
            On success,
            If Client of message is GaganRobot:
                the sent :obj:`Message` or True is returned.
            if Client of message is GaganRobotBot:
